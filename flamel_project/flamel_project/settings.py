"""
Django settings for flamel_project project.
...
SECRET_KEY = 'django-insecure-y&kjg#g)uy+&+y9=idzsz#)+3afofi18-fsay_bjt!(!p*8lad'
...
# Adicione também a configuração para o upload de arquivos
MEDIA_URL = '/media/'
...
ROOT_URLCONF = 'flamel_project.urls'
...
WSGI_APPLICATION = 'flamel_project.wsgi.application'
