        ...
        <div>
            <div className="w-fit">
                <div className="flex items-center justify-center min-h-[280px] ">
                    <div className="relative bg-white/10 bg-cciGradientPrimary backdrop-blur-md border border-white/20 rounded-3xl px-6 pt-6 pb-[10px] w-80 shadow-xl">
                        {/* Circular Button */}
                        ...
                        <p className="text-center text-white text-base font-light mt-1 cursor-default" onClick={async () => {
                            {/* Screenshot and Debug commands - Only show if not processing */ }
                            if (!isProcessing) {
                                try {
                                    const result =
                        ...
                        <div>
                            <div className="border-b mt-2 mb-2 border-gray-500 border w-[280px] mx-auto"></div>
                            <div className="flex items-center justify-center" onClick={async () => {
                                try {
                                    const result =
                                        await window.electronAPI.triggerReset();
    ...
    return (
        <div>
            <div className="pt-2 w-fit">
                <div className="text-xs text-white/90 backdrop-blur-md bg-cciGradientSecondary rounded-3xl py-2 px-4 flex items-center justify-center gap-4">
