...
export const ElegantDesign: React.FC<any> = ({
  ...
  return (
    <div className="flex items-center justify-center w-[90px]">
      <div className="relative bg-white/10 bg-cciGradientPrimary backdrop-blur-md border border-white/20 rounded-3xl p-6 px-4 py-6 w-80 shadow-xl">
        {/* Side Buttons */}
        <div
        ...
        >
          ...
          {/* Toggle icon */}
          <div
            className="relative inline-block hover:bg-white/20"
